...
public class BoosterBuyerHP : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        //Payment
        if (Gamecontroller.HappinessAmount > 100000000000)
        {
            Gamecontroller.HappinessAmount = Gamecontroller.HappinessAmount - 100000000000f;
