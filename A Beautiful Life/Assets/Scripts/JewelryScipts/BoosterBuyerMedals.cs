...
public class BoosterBuyerMedals : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        //Payment
        if (Gamecontroller.MedalCountAging > 4 && Gamecontroller.MedalCountBreathing > 4 && Gamecontroller.MedalCountPeeing > 4)
        {
            Gamecontroller.MedalCountAging = Gamecontroller.MedalCountAging - 5;
            Gamecontroller.MedalCountPeeing = Gamecontroller.MedalCountPeeing - 5;
            Gamecontroller.MedalCountBreathing = Gamecontroller.MedalCountBreathing - 5;
